...
function computeCategoryTotals(transactions: Transaction[], type: 'income' | 'expense'): CategoryTotal[] {
...
export default function DashboardPage() {
  ...
  const incomeTotals = computeCategoryTotals(transactions, 'income')
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading ? (
          ...
          <>
            <ExpenseChart data={expenseTotals} />
            <IncomeChart data={incomeTotals} />
          </>
        )}
      </div>
